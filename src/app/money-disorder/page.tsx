...
export default function MoneyDisorderPage() {
  return (
    <div>
      <div className="md:px-20 py-20 max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Money is not the answer.</h1>
        <div className="relative w-full h-[30rem] mb-8 overflow-y-auto">
          <Image
            src="/images/new_book.jpg"
            alt="Money Disorder Book Cover"
            fill
            className="md:object-cover object-contain rounded-lg"
            priority
          />
        </div>
        <div className="mb-5">
          <>
            ...
            <p className="mb-2">
              A struggling mechanic, Emeka, won ₩5 million in the state lottery.
              ...
              character, judgment, and vision.
            </p>
            <p className="mb-2">
              Emeka&apos;s predicament defines what I call money disorder: the
              mishandling of money due to an underlying lack of readiness. When
              money arrives out of order—before a person is prepared for it—the
              consequences can be devastating, whether that person is struggling
              to survive or sitting on mountains of wealth.
            </p>
            <p className="mb-2">
              ...
              varies from one person to another. I use the term JNSQ (Je ne sais
              quoi, or &quot;I don&apos;t know what&quot;) to describe it. JNSQ
              is that essential &quot;something&quot; that makes an individual
              capable of handling resources wisely. It is that foundation that
              must be in place to support true success, impact, and fulfillment.
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              The scope of Part 1 of the book includes those who lack sufficient
              money to do what they want and the two types of money disorder
              that affect them:
            </p>
            ...
            <p className="mb-2">
              ...
              amount of money will bring lasting change.
            </p>
            <p className="mb-2">
              Part 2 turns the spotlight onto the haves—those with more than
              enough money, often much more. Here, the problem shifts from
              scarcity to excess. While it may seem that the have-nots and the
              haves live in different worlds, the root issue is the same: a
              misplaced faith in money as the ultimate answer, rather than the
              development of JNSQ—the readiness to steward resources wisely and
              responsibly.
            </p>
            <p className="mb-2">
              ...
              master. Without it, even great fortunes can become instruments of
              personal and societal harm. This message is especially urgent for
              young people, who may erroneously believe that success equals
              wealth. True success comes from the internal strength to wield
              resources—not the mere possession of them. If you are a young
              person, hear this clearly: money is not the measure of your
              success. Readiness is. When you focus on developing JNSQ, the
              money you need will come—and when it does, it will not master you.
              You will master it.
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              ...
              money. It is about becoming ready. And when you are ready, the
              money you do have will work for you, not against you.
            </p>
          </>
        </div>
        <div className="mt-8">
